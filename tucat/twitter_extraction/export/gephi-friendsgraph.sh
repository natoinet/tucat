...
cat "$OUTPUT_FILES/archivo-node-mod-$1-$COLLECTION.csv" "$OUTPUT_FILES/archivo-edge-mod-$1-$COLLECTION.csv" >> "$OUTPUT_FILES/grafo-friends-$1-$COLLECTION.gdf"
...
echo "$OUTPUT_FILES/grafo-friends-$1-$COLLECTION.gdf"
